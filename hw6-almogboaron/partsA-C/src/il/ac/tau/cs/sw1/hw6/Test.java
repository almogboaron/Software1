...
public static void main(String[] args) {
		...
		Polynomial p6 = p5.getFirstDerivation();
		printError(p6.getDegree() == 0,
				"the degree of p6 is 0");
		double[] coefficients2 = new double[]{1.0,2.0,1.0};
		Polynomial p7 = new Polynomial(coefficients2);
		printError(p7.isExtrema(-1),
				"exterma is -1");
	}
